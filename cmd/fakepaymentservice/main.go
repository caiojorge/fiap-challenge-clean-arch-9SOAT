...
import payment "github.com/caiojorge/fiap-challenge-ddd/internal/shared/fake"
...
func main() {
	...
	// r.POST("/instore/orders/qr/seller/collectors/:collectorID/pos/:posID/qrs", func(c *gin.Context) {
