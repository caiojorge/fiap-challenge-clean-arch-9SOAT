...
// 	dto "github.com/caiojorge/fiap-challenge-ddd/internal/core/usecase/order/shared"
...
// 	dto := OrderDTO{
// 		ID:          "order123",
// 		Items:       []*dto.OrderItemDTO{{ID: "item1", ProductID: "product1", Quantity: 2, Price: 10.0, Status: "new"}},
// 		Total:       20.0,
// 		Status:      "pending",
